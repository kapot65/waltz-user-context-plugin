[![Build Status](https://travis-ci.org/waltz-controls/waltz-user-context-plugin.svg?branch=master)](https://travis-ci.org/waltz-controls/waltz-user-context-plugin)
